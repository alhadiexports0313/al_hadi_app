    ...
    <main className="min-h-screen bg-white dark:bg-slate-900 transition-colors duration-500">
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage: `url('/images/manufacturing/hero.webp')`,
        ...
        <div className="relative z-10 text-center text-gray-900 dark:text-white px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto w-full">
          <h1
            className={`text-3xl xs:text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold mb-4 sm:mb-6 leading-tight transition-all duration-1000 ease-out text-gray-900 dark:text-white ${
          ...
          <p
            className={`text-base xs:text-lg sm:text-xl text-gray-900 dark:text-gray-100 md:text-2xl lg:text-3xl xl:text-4xl mb-6 sm:mb-8 lg:mb-10 xl:mb-12 font-medium leading-relaxed max-w-4xl mx-auto transition-all duration-1000 ease-out delay-300 ${
              isLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
          >
          ...
          <div
            className={`flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center max-w-lg mx-auto transition-all duration-1000 ease-out delay-600 ${
              isLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
          >
            <Link
            ...
            >
              <Button
                variant="secondary"
                size="lg"
                className="w-full sm:w-auto text-gray-900 dark:text-gray-100 text-sm sm:text-base lg:text-lg px-4 sm:px-6 lg:px-8 py-3 sm:py-4 hover:scale-105 transition-transform duration-300 shadow-lg hover:shadow-xl bg-white dark:bg-slate-800 hover:bg-gray-50 dark:hover:bg-slate-700 border border-gray-200 dark:border-slate-600"
              >
                Explore Our Quality
                <ArrowRight
            ...
            >
              <Download
                ...
                aria-hidden="true"
              />
              <span className="hidden xs:inline">Download Company Profile</span>
              <span className="xs:hidden">Download Profile</span>
            </Button>
          </div>
        </div>
        ...
        {/* Scroll Indicator */}
        <div
          className={`absolute bottom-8 left-1/2 transform -translate-x-1/2 text-white dark:text-gray-200 transition-all duration-1000 ease-out delay-1000 
      ...
      {/* Stats Section */}
      <section
        className="py-12 sm:py-16 bg-gray-50 dark:bg-slate-800 transition-colors duration-500"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            {stats.map((stat, index) => (
              <div
                key={index}
                className="text-center p-4 rounded-lg hover:bg-white dark:hover:bg-slate-700 transition-colors duration-300 animate-fade-in"
                style={{ animationDelay: `${index * 100}ms` }}
              >
                <div className="text-2xl sm:text-3xl md:text-4xl font-bold text-primary dark:text-blue-400 mb-2 transition-colors duration-300">
                  {stat.number}
                </div>
                <div className="text-gray-600 dark:text-gray-300 font-medium text-xs sm:text-sm md:text-base transition-colors duration-300">
                  {stat.label}
                </div>
                <div className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 transition-colors duration-300">
                  {stat.description}
                </div>
              </div>
            ))}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto transition-colors duration-300">
              Driving excellence in garment manufacturing through innovation,
          ...
          <div className="grid md:grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 mb-12 sm:mb-16">
            ...
            <Card className="text-center lg:text-left group hover:shadow-xl dark:hover:shadow-blue-500/10 transition-all duration-300 bg-white dark:bg-slate-800 border-gray-200 dark:border-slate-700">
              <CardContent className="p-6 sm:p-8">
                ...
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed text-base sm:text-lg transition-colors duration-300">
                  To emerge as a global pioneer in sustainable garment
                  manufacturing, setting new benchmarks for quality, innovation,
                  and ethical excellence. Our core policy focuses on women&apos;s
                  empowerment and well-being, while our long-term goals
                  emphasize eco-friendly production and a steadfast commitment
                  to reducing our carbon footprint. Through these principles, we
                  strive to foster a sustainable, inclusive, and
                  forward-thinking work environment that benefits both people
                  and the planet.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center lg:text-left group hover:shadow-xl dark:hover:shadow-purple-500/10 transition-all duration-300 bg-white dark:bg-slate-800 border-gray-200 dark:border-slate-700">
              <CardContent className="p-6 sm:p-8">
                ...
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed text-base sm:text-lg transition-colors duration-300">
                  To create exceptional garments that blend traditional
                  craftsmanship with modern innovation. We are dedicated to
                  sustainability, ethical production, and continuous improvement
                  — ensuring every product exceeds customer expectations in
                  quality, design, and service, while fostering a positive
                  impact on people and the planet through responsible and
                  forward-thinking manufacturing practices.
                </p>
              </CardContent>
            </Card>
          </div>
          ...
          {/* Core Values */}
          <div
            className="bg-gradient-to-r from-blue-50 to-teal-50 dark:from-slate-800 dark:to-slate-700 rounded-xl sm:rounded-2xl p-6 sm:p-8 lg:p-12 transition-colors duration-500"
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300 transition-colors duration-300">
                  Pursuing perfection in every stitch, every process, and every
                  partnership.
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300 transition-colors duration-300">
                  Committed to environmental responsibility and ethical
              ...
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300 transition-colors duration-300">
                  Building trust through transparency, honesty, and reliable
                  partnerships.
                </p>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto transition-colors duration-300">
              ...
              deliver exceptional garments that meet global standards.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {whyChooseUs.map((feature, index) => {
              ...
              return (
                <Card
                  key={index}
                  className="text-center bg-white dark:bg-slate-800 border-gray-200 dark:border-slate-700 hover:shadow-lg dark:hover:shadow-blue-500/10 transition-all duration-300"
                >
                  <CardHeader>
                    <div
                      className={`w-12 h-12 ${index % 2 === 0 ? "bg-gradient-primary dark:bg-gradient-to-r dark:from-blue-600 dark:to-blue-700" : "bg-gradient-accent dark:bg-gradient-to-r dark:from-purple-600 dark:to-purple-700"} rounded-lg flex items-center justify-center mb-6 mx-auto transition-colors duration-300`}
                    >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto px-4 transition-colors duration-300">
              From formal wear to casual clothing, we manufacture a diverse
              range of high-quality garments for global markets.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {products.slice(0, 6).map((product, index) => (
              <Card
                key={product.id}
                className="overflow-hidden group hover:shadow-lg dark:hover:shadow-blue-500/10 transition-all duration-300 animate-fade-in bg-white dark:bg-slate-800 border-gray-200 dark:border-slate-700"
                style={{ animationDelay: `${index * 100}ms` }}
              >
                ...
                <CardContent className="p-4 sm:p-6">
                  <h3 className="text-lg sm:text-xl font-semibold mb-2 group-hover:text-primary dark:group-hover:text-blue-400 transition-colors text-gray-900 dark:text-gray-100">
                    {product.name}
                  </h3>
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between text-xs sm:text-sm gap-2 sm:gap-1">
                      ...
                      <div className="flex flex-wrap gap-1">
                        {product.certifications.map((cert, i) => (
                          <span
                            key={i}
                            className="px-2 py-1 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400 rounded text-xs hover:bg-green-200 dark:hover:bg-green-900/50 transition-colors"
                          >
                            {cert}
                          </span>
                        ))}
      ...
      <section className="py-20 bg-white dark:bg-slate-900 transition-colors duration-500">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto transition-colors duration-300">
              Trusted by businesses worldwide for quality, reliability, and
              exceptional service.
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-primary dark:bg-gradient-to-r dark:from-slate-800 dark:to-slate-700 text-white transition-colors duration-500">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 max-w-3xl mx-auto opacity-90">
            Contact us today to discuss your garment manufacturing needs and get
