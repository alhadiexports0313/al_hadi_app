  ...
  const clientLogos = [
    {
      ...
      partnership: "8+ years",
      image: "/images/Trusted Brands/Newlook.webp",
    },
    {
      name: "Zara",
      category: "Fashion Retail",
      partnership: "3+ years",
      image: "/images/Trusted Brands/Zara.webp",
    },
    {
      name: "Kik",
      category: "Casual Wear",
      partnership: "6+ years",
      image: "/images/Trusted Brands/Kik.webp",
    },
    {
      name: "Exist",
      category: "American Apparel",
      partnership: "6+ years",
      image: "/images/Trusted Brands/Exist.webp",
    },
    {
      name: "Woolworth",
      category: "Germany Retail",
      partnership: "7+ years",
      image: "/images/Trusted Brands/Woolworth.webp",
    },
    {
      name: "Tedi",
      category: "Germany Retail",
      partnership: "2+ years",
      image: "/images/Trusted Brands/Tedi.webp",
    },
    {
      name: "LPP",
      category: "Poland Retail",
      partnership: "5+ years",
      image: "/images/Trusted Brands/LPP.webp",
    },
    {
      name: "inStyle",
      category: "Italy Fashion",
      partnership: "4+ years",
      image: "/images/Trusted Brands/inStyle.webp",
    },
    {
      name: "Sherwin Willims",
      category: "Canada",
      partnership: "1+ years",
      image: "/images/Trusted Brands/Sherwin willims.webp",
    },
    {
      name: "Prime",
      category: "Saudi Arabia",
      partnership: "3+ years",
      image: "/images/Trusted Brands/Prime.webp",
    },
    {
      name: "Miltex",
      category: "USA Retail",
      partnership: "3+ years",
      image: "/images/Trusted Brands/Miltex.webp",
    },
    {
      name: "Champion",
      category: "American Retail",
      partnership: "3+ years",
      image: "/images/Trusted Brands/Champion.webp",
    },
  ];
  ...
  const partnershipBenefits = [
    {
      ...
      title: "Global Reach",
      description:
        "Serving clients across 9+ countries with reliable supply chain management",
    },
    {
      icon: Users,
      title: "Dedicated Support",
      description:
        "Assigned account managers for personalized service and communication",
    },
    {
      icon: TrendingUp,
      title: "Scalable Solutions",
      description:
        "Flexible production capacity to meet growing business demands",
    },
    {
      icon: Award,
      title: "Quality Assurance",
      description:
        "Consistent quality standards maintained across all client orders",
    },
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6 dark:text-blue-200 transition-colors duration-300">
              Our Global{" "}
              <span className="text-accent dark:text-blue-400">Partners</span>
            </h1>
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto opacity-90 dark:text-blue-100 transition-colors duration-300">
              Trusted by leading brands worldwide for premium quality garment
              manufacturing
            </p>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-12">
              <div className="text-center">
                <div className="text-3xl md:text-4xl font-bold text-accent dark:text-blue-400 transition-colors duration-300">
                  {stats[1].number}
                </div>
                <div className="text-sm md:text-base opacity-90 dark:text-blue-200 transition-colors duration-300">
                  Countries Served
                </div>
              </div>
              <div className="text-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto transition-colors duration-300">
              Our manufacturing excellence reaches clients across five
              continents, delivering quality garments to major markets
              worldwide.
            </p>
          </div>
            ...
            <div className="relative">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600 dark:text-gray-300 transition-colors duration-300">
                  Manufacturing and delivering across 9+ countries
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {globalPresence.map((region, index) => (
                  <Card
                    key={index}
                    className="text-center hover:shadow-lg dark:hover:shadow-blue-500/10 transition-shadow dark:bg-slate-800 dark:border-slate-600"
                  >
                    <CardContent className="p-6">
                      <div
                        className={`w-12 h-12 ${region.color} rounded-full flex items-center justify-center mb-4 mx-auto`}
                      >
                      ...
                      <p className="text-2xl font-bold text-primary dark:text-blue-400 mb-2 transition-colors duration-300">
      ...
      <section className="py-20 dark:bg-slate-900 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto transition-colors duration-300">
              We&apos;re proud to partner with some of the world&apos;s most
              recognized fashion and retail brands, delivering consistent
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-4 md:gap-5 lg:gap-6">
            {clientLogos.map((client, index) => (
              <Card
                key={index}
                className="group hover:shadow-lg dark:hover:shadow-blue-500/10 transition-all duration-300 hover:-translate-y-1 bg-white dark:bg-slate-800 border border-gray-100 dark:border-slate-700 hover:border-gray-200 dark:hover:border-blue-500"
              >
                <CardContent className="p-3 md:p-4 text-center">
                  ...
                  <h3 className="text-xs md:text-sm font-semibold text-gray-900 dark:text-gray-100 mb-1 truncate leading-tight transition-colors duration-300">
                    {client.name}
                  </h3>
                  <p className="text-xs text-gray-600 dark:text-gray-400 mb-2 truncate transition-colors duration-300">
                    {client.category}
                  </p>
          ...
          <div className="mt-16 bg-gradient-primary dark:from-blue-700 dark:to-blue-800 rounded-2xl p-8 text-white text-center transition-colors duration-300">
            ...
            <div className="grid md:grid-cols-4 gap-8">
              <div>
                <div className="text-3xl font-bold text-accent dark:text-blue-400 mb-2 transition-colors duration-300">
                  98%
                </div>
                <div className="text-sm opacity-90 dark:text-blue-100 transition-colors duration-300">
              ...
              <CardContent className="text-center">
                <div className="flex justify-center mb-6">
                  {[...Array(5)].map((_, i) => (
                    <Star
                      key={i}
                      className={`w-6 h-6 ${i < testimonials[currentTestimonial].rating ? "text-yellow-400 fill-current" : "text-gray-300 dark:text-gray-500"} transition-colors duration-300`}
                    />
                  ))}
                </div>
      ...
      <section className="py-20 bg-gradient-primary dark:from-blue-700 dark:to-blue-800 text-white transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 max-w-3xl mx-auto opacity-90 dark:text-blue-100 transition-colors duration-300">
            Become part of our growing family of satisfied clients. Let&apos;s
            discuss how we can support your garment manufacturing needs with our
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/contact">
              <Button
                variant="outline"
                size="lg"
                className="border-white text-white hover:bg-purple-600 hover:text-white dark:border-slate-200 dark:text-slate-200 dark:hover:bg-slate-600 dark:hover:text-slate-200 transition-all duration-300"
              >
