    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-300 leading-relaxed text-sm lg:text-base mb-4">
                To deliver world-class garments that combine traditional
                craftsmanship with modern innovation, ensuring sustainable
                practices and exceeding customer expectations in quality,
                design, and service.
              </p>
              <p className="text-gray-400 text-sm">
                Trusted by leading brands worldwide for premium apparel
            ...
            <div>
              ...
              <div className="flex space-x-4">
                <a
                  href="#"
                  className="bg-blue-800/30 p-3 rounded-lg text-blue-400 hover:bg-blue-700/40 hover:text-blue-300 transition-all duration-200 transform hover:scale-110"
                >
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-lg font-semibold text-blue-300 mb-6">
              Quick Links
            </h4>
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center space-y-4 lg:space-y-0">
            <div className="text-center lg:text-left">
              ...
              <p className="text-gray-500 text-xs">
                Committed to excellence in garment manufacturing and export
                since 2010.
              </p>
            </div>
